...
defmodule JSV.Generated.Draft202012.AtomKeys.PropertyNamesTest do
  ...
  describe "propertyNames validation" do
    setup do
      json_schema = %JSV.Schema{
        ...
        propertyNames: %JSV.Schema{maxLength: 3}
      }
  ...
  describe "propertyNames validation with pattern" do
    setup do
      json_schema = %JSV.Schema{
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        propertyNames: %JSV.Schema{pattern: "^a+$"}
      }
  ...
  describe "propertyNames with enum" do
    setup do
      json_schema = %JSV.Schema{
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        propertyNames: %JSV.Schema{enum: ["foo", "bar"]}
      }
