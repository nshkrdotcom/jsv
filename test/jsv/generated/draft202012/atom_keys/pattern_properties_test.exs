...
defmodule JSV.Generated.Draft202012.AtomKeys.PatternPropertiesTest do
  ...
  describe "patternProperties validates properties matching a regex" do
    setup do
      json_schema = %JSV.Schema{
        ...
        patternProperties: %{"f.*o": %JSV.Schema{type: "integer"}}
      }
  ...
  describe "patternProperties with null valued instance properties" do
    setup do
      json_schema = %JSV.Schema{
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        patternProperties: %{"^.*bar$": %JSV.Schema{type: "null"}}
      }
