...
defmodule JSV.Generated.Draft202012.DecimalValues.RelativeJsonPointerTest do
  alias JSV.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft2020-12/optional/format/relative-json-pointer.json
  """
