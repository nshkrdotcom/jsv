...
defmodule JSV.Generated.Draft7.AtomKeys.TypeTest do
  ...
  describe "object type matches objects" do
    setup do
      json_schema = %JSV.Schema{type: "object"}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "array type matches arrays" do
    setup do
      json_schema = %JSV.Schema{type: "array"}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "boolean type matches booleans" do
    setup do
      json_schema = %JSV.Schema{type: "boolean"}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "null type matches only the null object" do
    setup do
      json_schema = %JSV.Schema{type: "null"}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "multiple types can be specified in an array" do
    setup do
      json_schema = %JSV.Schema{type: ["integer", "string"]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "type: array or object" do
    setup do
      json_schema = %JSV.Schema{type: ["array", "object"]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "type: array, object or null" do
    setup do
      json_schema = %JSV.Schema{type: ["array", "object", "null"]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
