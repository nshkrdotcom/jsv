...
defmodule JSV.Generated.Draft7.AtomKeys.MinPropertiesTest do
  alias JSV.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft7/minProperties.json
  """

  describe "minProperties validation" do
    setup do
      json_schema = %JSV.Schema{minProperties: 1}
  ...
  describe "minProperties validation with a decimal" do
    setup do
      json_schema = %JSV.Schema{minProperties: 1.0}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
