...
defmodule JSV.Generated.Draft7.AtomKeys.ContainsTest do
  ...
  describe "contains keyword validation" do
    setup do
      json_schema = %JSV.Schema{contains: %JSV.Schema{minimum: 5}}
  ...
  describe "contains keyword with const keyword" do
    setup do
      json_schema = %JSV.Schema{contains: %{const: 5}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "contains keyword with boolean schema true" do
    setup do
      json_schema = %JSV.Schema{contains: true}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "contains keyword with boolean schema false" do
    setup do
      json_schema = %JSV.Schema{contains: false}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "contains with false if subschema" do
    setup do
      json_schema = %JSV.Schema{contains: %JSV.Schema{else: true, if: false}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "contains with null instance elements" do
    setup do
      json_schema = %JSV.Schema{contains: %JSV.Schema{type: "null"}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
