...
defmodule JSV.Generated.Draft7.AtomKeys.UniqueItemsTest do
  ...
  describe "uniqueItems validation" do
    setup do
      json_schema = %JSV.Schema{uniqueItems: true}
  ...
  describe "uniqueItems with an array of items" do
    setup do
      json_schema = %JSV.Schema{
        items: [%JSV.Schema{type: "boolean"}, %JSV.Schema{type: "boolean"}],
        uniqueItems: true
      }
  ...
  describe "uniqueItems=false validation" do
    setup do
      json_schema = %JSV.Schema{uniqueItems: false}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
