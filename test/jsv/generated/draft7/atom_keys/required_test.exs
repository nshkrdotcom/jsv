...
defmodule JSV.Generated.Draft7.AtomKeys.RequiredTest do
  ...
  describe "required default validation" do
    setup do
      json_schema = %JSV.Schema{properties: %{foo: %JSV.Schema{}}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "required with empty array" do
    setup do
      json_schema = %JSV.Schema{properties: %{foo: %JSV.Schema{}}, required: []}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "required properties whose names are Javascript object property names" do
    setup do
      json_schema = %JSV.Schema{required: ["__proto__", "toString", "constructor"]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
