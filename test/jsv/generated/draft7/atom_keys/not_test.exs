...
defmodule JSV.Generated.Draft7.AtomKeys.NotTest do
  ...
  describe "not" do
    setup do
      json_schema = %JSV.Schema{not: %JSV.Schema{type: "integer"}}
  ...
  describe "not multiple types" do
    setup do
      json_schema = %JSV.Schema{not: %JSV.Schema{type: ["integer", "boolean"]}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "forbidden property" do
    setup do
      json_schema = %JSV.Schema{properties: %{foo: %JSV.Schema{not: %JSV.Schema{}}}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "forbid everything with empty schema" do
    setup do
      json_schema = %JSV.Schema{not: %JSV.Schema{}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "forbid everything with boolean schema true" do
    setup do
      json_schema = %JSV.Schema{not: true}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allow everything with boolean schema false" do
    setup do
      json_schema = %JSV.Schema{not: false}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "double negation" do
    setup do
      json_schema = %JSV.Schema{not: %JSV.Schema{not: %JSV.Schema{}}}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
