...
defmodule JSV.Generated.Draft7.AtomKeys.AllOfTest do
  alias JSV.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft7/allOf.json
  """
  ...
  describe "allOf simple types" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{maximum: 30}, %JSV.Schema{minimum: 20}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with boolean schemas, all true" do
    setup do
      json_schema = %JSV.Schema{allOf: [true, true]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with boolean schemas, some false" do
    setup do
      json_schema = %JSV.Schema{allOf: [true, false]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with boolean schemas, all false" do
    setup do
      json_schema = %JSV.Schema{allOf: [false, false]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with one empty schema" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with two empty schemas" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{}, %JSV.Schema{}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with the first empty schema" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{}, %JSV.Schema{type: "number"}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf with the last empty schema" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{type: "number"}, %JSV.Schema{}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "nested allOf, to check validation semantics" do
    setup do
      json_schema = %JSV.Schema{allOf: [%JSV.Schema{allOf: [%JSV.Schema{type: "null"}]}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "allOf combined with anyOf, oneOf" do
    setup do
      json_schema = %JSV.Schema{
        allOf: [%JSV.Schema{multipleOf: 2}],
        anyOf: [%JSV.Schema{multipleOf: 3}],
        oneOf: [%JSV.Schema{multipleOf: 5}]
      }
