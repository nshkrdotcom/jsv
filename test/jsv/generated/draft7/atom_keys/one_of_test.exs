...
defmodule JSV.Generated.Draft7.AtomKeys.OneOfTest do
  ...
  describe "oneOf" do
    setup do
      json_schema = %JSV.Schema{oneOf: [%JSV.Schema{type: "integer"}, %JSV.Schema{minimum: 2}]}
  ...
  describe "oneOf with boolean schemas, all true" do
    setup do
      json_schema = %JSV.Schema{oneOf: [true, true, true]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "oneOf with boolean schemas, one true" do
    setup do
      json_schema = %JSV.Schema{oneOf: [true, false, false]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "oneOf with boolean schemas, more than one true" do
    setup do
      json_schema = %JSV.Schema{oneOf: [true, true, false]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "oneOf with boolean schemas, all false" do
    setup do
      json_schema = %JSV.Schema{oneOf: [false, false, false]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "oneOf with empty schema" do
    setup do
      json_schema = %JSV.Schema{oneOf: [%JSV.Schema{type: "number"}, %JSV.Schema{}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "nested oneOf, to check validation semantics" do
    setup do
      json_schema = %JSV.Schema{oneOf: [%JSV.Schema{oneOf: [%JSV.Schema{type: "null"}]}]}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
