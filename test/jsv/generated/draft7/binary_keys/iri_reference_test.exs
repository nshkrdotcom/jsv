...
defmodule JSV.Generated.Draft7.BinaryKeys.IriReferenceTest do
  alias JSV.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft7/optional/format/iri-reference.json
  """
