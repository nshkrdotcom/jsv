...
defmodule JSV.Generated.Draft7.BinaryKeys.DefaultTest do
  ...
  describe "invalid type for default" do
    setup do
      json_schema = %{"properties" => %{"foo" => %{"type" => "integer", "default" => []}}}
  ...
  describe "invalid string value for default" do
    setup do
      json_schema = %{
        "properties" => %{
          "bar" => %{"type" => "string", "default" => "bad", "minLength" => 4}
        }
      }
  ...
  describe "the default keyword does not do anything if the property is missing" do
    setup do
      json_schema = %{
        "type" => "object",
        "properties" => %{
          "alpha" => %{"type" => "number", "default" => 5, "maximum" => 3}
        }
      }
