...
defmodule JSV.Generated.Draft7.BinaryKeys.RefRemoteTest do
  ...
  describe "fragment within remote ref" do
    setup do
      json_schema = %{"$ref" => "http://localhost:1234/draft7/subSchemas.json#/definitions/integer"}
      schema = JsonSchemaSuite.build_schema(json_schema, default_meta: "http://json-schema.org/draft-07/schema")
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "remote ref with ref to definitions" do
    setup do
      json_schema = %{
        ...
        "allOf" => [%{"$ref" => "draft7/ref-and-definitions.json"}]
      }
